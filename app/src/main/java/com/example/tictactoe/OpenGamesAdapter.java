...
public class OpenGamesAdapter extends RecyclerView.Adapter<OpenGamesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        if (lobbies != null) {
            ...
            holder.mIdView.setText("Host: "+lobby.host.getUsername());
            holder.mContentView.setText("Wins: "+String.valueOf(lobby.host.getWins())+" | Losses: "+String.valueOf(lobby.host.getLosses())+" | Draws: "+String.valueOf(lobby.host.getDraws()));
        }
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void lobbyLaunch(View v) {
            NavDirections action = DashboardFragmentDirections.actionGame(lobbies.get(getAdapterPosition()).gameID);
